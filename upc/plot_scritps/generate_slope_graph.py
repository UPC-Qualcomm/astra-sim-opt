...
def generate_slope_graph(g2_file=None, analytical_file=None, title="default title", output_path="order_comparison",
    ...
    """Generate slope graph comparing g2, ns3 (optional), and analytical orderings.

    Args:
        g2_file: Path to G2 results CSV
    ...
    print(f"Merged G2 ∩ Analytical configurations: {n_configs}")
    ...
    print(f"Scaling Factor = G2 range / Analytical range = {relative_scale_factor:.4f}")
    if has_ns3:
        print(f"Scaling Factor = NS3 range / Analytical range = {ns3_ana_scale_factor:.4f}")
        print(f"Scaling Factor = NS3 range / G2 range        = {ns3_g2_scale_factor:.4f}")
    print(f"\nInterpretation (G2 vs Analytical):")
    if relative_scale_factor > 1.05:
        print(f"  → G2 has {relative_scale_factor:.2f}x MORE variability in results than Analytical")
        print(f"  → G2 shows a WIDER spread of execution times across configurations")
    elif relative_scale_factor < 0.95:
        print(f"  → G2 has {1/relative_scale_factor:.2f}x LESS variability than Analytical")
        print(f"  → G2 shows a NARROWER spread of execution times across configurations")
    else:
    ...
    scale_interpretation = ("same range" if 0.95 <= relative_scale_factor <= 1.05 else
                             f"G2 is {relative_scale_factor:.2f}x wider" if relative_scale_factor > 1.05 else
                             f"G2 is {1/relative_scale_factor:.2f}x smaller")
    title_text = f'{title}\n'
    title_text += (f'G2 vs Analytical — Spearman ρ={spearman_corr_ana_g2:.4f} | '
    ...
    title_text += f'Scale Factor G2/Analytical: {relative_scale_factor:.4f} ({scale_interpretation})'
    if has_ns3:
    ...
    legend_text += f'• G2 ∩ Analytical configs: {n_configs}\n'
    legend_text += f'• G2 range: {g2_range:,.0f} cycles\n'
    legend_text += f'• Analytical range: {analytical_range:,.0f} cycles\n'
    legend_text += f'• Scale factor (G2/Analytical): {relative_scale_factor:.4f}x\n'
    if has_ns3:
        legend_text += f'• Scale factor (NS3/Analytical): {ns3_ana_scale_factor:.4f}x\n'
        legend_text += f'• Scale factor (NS3/G2): {ns3_g2_scale_factor:.4f}x\n'
    legend_text += f'─── G2 vs Analytical ───\n'
    ...
    print("\nConfigurations that ranked BETTER in G2 (improved the most):")
    ...
    print("\nConfigurations that ranked WORSE in G2 (degraded the most):")
...
if __name__ == "__main__":
    #if len(sys.argv) != 4:
    #    print("Usage: python generate_slope_graph.py <g2_csv_path> <analytical_csv_path> <title>")
    #    print("\nExample:")
    #    print('  python generate_slope_graph.py \\')
    #    print('    /path/to/g2/FoldedClos_iter2.csv \\')
    #    print('    /path/to/analytical/FoldedClos.csv \\')
    #    print('    "Order Comparison: G2 vs Analytical (64 NPUs)"')
    #    sys.exit(1)
    
    #g2_file = sys.argv[1]
    #analytical_file = sys.argv[2]
    #title = sys.argv[3]
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_disabled_sync16_256_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_sync16_256_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: No Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_no_sync_16_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fix16_256_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_my_sync_fix16_256_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: My Sync solution. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_fix_16_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_sync16_256_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_sync16_256_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: Astra Sync solution. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_astra_sync_16_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fix16_256_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_sync16_256_16/FoldedClos.csv"
    #title = "G2 Synced vs Analytical No Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_fix_vs_no_sync_16_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fix16_256_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_sync16_256_16/FoldedClos_iter2.csv"
    #title = "My Sync vs Astra Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_vs_astra_sync_16_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #
    ...
    ##64 NPUs
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_disabled_sync64/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_3_1300M_analytical_astra_no_sync64/FoldedClos.csv"
    #title = "G2 Vs Analytical: No Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 64"
    #output_filename = "slope_graph_no_sync_64_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_my_sync_fix64/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_3_1300M_analytical_my_sync_fix64/FoldedClos.csv"
    #title = "G2 Vs Analytical: My Sync solution. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 64"
    #output_filename = "slope_graph_my_sync_fix_64_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_Astra_sync64/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_3_1300M_analytical_astra_sync64/FoldedClos.csv"
    #title = "G2 Vs Analytical: Astra Sync solution. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 64"
    #output_filename = "slope_graph_astra_sync_64_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_my_sync_fix64/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_3_1300M_analytical_astra_no_sync64/FoldedClos.csv"
    #title = "G2 Synced vs Analytical No Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 64"
    #output_filename = "slope_graph_my_sync_fix_vs_no_sync_64_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_my_sync_fix64/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/results_server/GPT_1.3B_test_g2_Astra_sync64/FoldedClos_iter2.csv"
    #title = "My Sync vs Astra Sync. Model:GPT 1.3B, Topology: FoldedClos, NPUs: 64"
    #output_filename = "slope_graph_my_sync_vs_astra_sync_64_NPUs"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    ##################################
    ##Xavi Ex Small 16 NPUs
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_disabled_syncxavi_ex_small_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: No Sync. Model:GPT Single layer, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_no_sync_16_NPUs_single_layer"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_my_sync_fixxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: My Sync solution. Model:GPT Single layer, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_fix_16_NPUs_single_layer"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_syncxavi_ex_small_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: Astra Sync solution. Model:GPT Single layer, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_astra_sync_16_NPUs_single_layer"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Synced vs Analytical No Sync. Model:GPT Single layer, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_fix_vs_no_sync_16_NPUs_single_layer"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_syncxavi_ex_small_16/FoldedClos_iter2.csv"
    #title = "My Sync vs Astra Sync. Model:GPT Single layer, Topology: FoldedClos, NPUs: 16"
    #output_filename = "slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    ##################################
    ##Xavi Ex Small 16 NPUs no intra
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_disabled_syncxavi_ex_small_16_no_intra/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: No Sync. Model: GPT Single layer, Topology: FoldedClos, NPUs: 16, No intra-links"
    #output_filename = "slope_graph_no_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16_no_intra/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_my_sync_fixxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: My Sync solution. Model: GPT Single layer, Topology: FoldedClos, NPUs: 16, No intra-links"
    #output_filename = "slope_graph_my_sync_fix_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_syncxavi_ex_small_16_no_intra/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Vs Analytical: Astra Sync solution. Model: GPT Single layer, Topology: FoldedClos, NPUs: 16, No intra-links"
    #output_filename = "slope_graph_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16_no_intra/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_no_syncxavi_ex_small_16/FoldedClos.csv"
    #title = "G2 Synced vs Analytical No Sync. Model: GPT Single layer, Topology: FoldedClos, NPUs: 16, No intra-links"
    #output_filename = "slope_graph_my_sync_fix_vs_no_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_my_sync_fixxavi_ex_small_16_no_intra/FoldedClos_iter2.csv"   
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_1.3B_test_g2_Astra_syncxavi_ex_small_16/FoldedClos_iter2.csv"
    #title = "My Sync vs Astra Sync. Model: GPT Single layer, Topology: FoldedClos, NPUs: 16, No intra-links"
    #output_filename = "slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    
    # Validate files exist
    #if not os.path.exists(g2_file):
    #    print(f"Error: G2 file not found: {g2_file}")
    #    g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_my_sync_fix16_256_16/FoldedClos.csv"
    #    #sys.exit(1)
    #if not os.path.exists(analytical_file):
    #    print(f"Error: Analytical file not found: {analytical_file}")
    #    analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_3_1300M_analytical_astra_sync16_256_16/FoldedClos.csv"
    #    #sys.exit(1)
    
    #generate_slope_graph(g2_file, analytical_file, title)

 
    #g2_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_40B_56L_test_g2_my_sync_fix_64_uniform_64_nvswitch_id_eout_dst_edge_src_pod/FoldedClos_iter2.csv"
    #ns3_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_40B_56L_test_g2_my_sync_fix_64_uniform_64_nvswitch_id_eout_ecmp/FoldedClos_iter2.csv"
    #analytical_file = "/media/mohammad/extension/experiments/astra-sim/upc/results/GPT_40B_56L_test_g2_my_sync_fix_64_uniform_64_nvswitch_id_eout_dst_edge_src_pod_hash/FoldedClos_iter2.csv"
    #title = "test_uniform_64_sum_vs_ecmp_vs_hash_slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links"
    #output_filename = "test_uniform_64_sum_vs_ecmp_vs_hash_slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename, ns3_file=ns3_file)
    
    
    g2_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_orderg2__64/FoldedClos.csv"
    ns3_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_orderns3__64/FoldedClos.csv"
    analytical_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_orderanalytical__64/FoldedClos.csv"
    title = "64_pckt_64K"
    output_filename = "64_pckt_64K"
    generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename, ns3_file=ns3_file)
    
    
    g2_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_order_pckt9000g2__64/FoldedClos.csv"
    ns3_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_order_pckt9000ns3__64/FoldedClos.csv"
    analytical_file = "/home/mohammad/Downloads/server order/res/GPT_40B_56L_order_pckt9000analytical__64/FoldedClos.csv"
    title = "64_pckt_9K"
    output_filename = "64_pckt_9K"
    generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename, ns3_file=ns3_file)
    ...
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test2/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_analytical_my_sync_fix_64_test2/FoldedClos.csv"
    #title = "GPT 60B: G2 Vs Analytical. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "Jordi slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test2/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_aprox_2/FoldedClos_iter2.csv"
    #title = "GPT 60B: G2 Vs Analytical. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "aprox slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_aprox_2_split_1/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_aprox_2/FoldedClos_iter2.csv"
    #title = "aprox: G2 split 1 Vs g2 no split. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "g2 1 vs g2 4 aprox slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_aprox_2_split_1/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_analytical_my_sync_fix_64_test_aprox_2_split_1/FoldedClos.csv"
    #title = "aprox: G2 aplit 1 Vs Analytical aplit 1. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "g2 split 1 vs ana 1 slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_analytical_my_sync_fix_64_test2/FoldedClos.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_analytical_my_sync_fix_64_test_aprox_2_split_1/FoldedClos.csv"
    #title = "Analytical aplit 4 Vs Analytical aplit 1. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "Ana 1 vs ana 4 slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_split_1/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test2/FoldedClos_iter2.csv"
    #title = "G2 1 Vs g2 4 no apprx. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "no aporx g2 1 vs g2 4 slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
    #
    #
    #g2_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_test_g2_my_sync_fix_64_test_split_1/FoldedClos_iter2.csv"   
    #analytical_file = "/app/astra-sim/upc/results/GPT_40B_56_layers_analytical_my_sync_fix_64_test_split_1/FoldedClos.csv"
    #title = "G2 1 Vs ana 1 no apprx. Network FoldedClos, NPUs: 64, Intra-bw: 1800GB/s, inter-bw: 400GB/s"
    #output_filename = "no aporx g2 1 vs ana 1 slope_graph_my_sync_vs_astra_sync_16_NPUs_single_layer_no_intra_links on_g2"
    #generate_slope_graph(g2_file, analytical_file, title, output_filename=output_filename)
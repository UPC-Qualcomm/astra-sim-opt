...
def run_power_estimation(
    ...
    Args:
        ...
        base_dir:          UPC base directory, used to resolve relative
    ...
    try:
        ...
        # Resolve UPC root robustly.
        # Prefer explicit base_dir from SimulationRunner, then ASTRA_SIM_ROOT.
        upc_root = base_dir if base_dir else os.path.join(os.environ.get('ASTRA_SIM_ROOT', ''), 'upc')

...
BASE_OUTPUT_DIR = "/app/astra-sim/upc/experiments_files/experiment2/workload/multiple_collectives_deterministic"
        ...
        with open(output_filename, "wb") as et:
            ...
            if npu_id in npu_to_groups and npu_to_groups[npu_id]:
                for group_id in npu_to_groups[npu_id]:
                    if coll_name == 'reduce_scatter' or coll_name == 'all_reduce':

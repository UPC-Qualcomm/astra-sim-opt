...
if __name__ == "__main__":
    ...
    for (cc, u_tgt_float, mi) in params:
        for bfsz in buffer_sizes:
            ...
            config_name = f"{project_root}upc/configuration/ns3/configs/FoldedClos_16_config{config_idx}.txt"
    ...
    print("To run a simulation, use: ./waf --run 'scratch/third /home/xavid/astra-sim/upc/configuration/ns3/configs/FoldedClos_16_configX.txt'")
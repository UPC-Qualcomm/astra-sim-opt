...
| Different pod | `h → [NVSwitch] → ToR_src → g{src_pod} → c_k → g{dst_pod} → ToR_dst → [NVSwitch] → h` |
...
|----------|:-----------------:|:---------------------:|
| FoldedClos K=4 | 4+8+8 = 20 | 4+4+8 = **16** |
| FoldedClos K=16 | 256+512+512 = 1280 | 256+16+512 = **784** |
